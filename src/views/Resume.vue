      ...
      <div class="resume-con">
        ...
        <div class="content">
          ...
          <div class="my-item"
            ...
            <Timeline>
              <TimelineItem>
                <p class="time">2018.11 – 2020.09 | 环球商付厦门科技有限公司</p>
                <p class="content">
          ...
          <div class="my-item"
            ...
            <Timeline>
              ...
              <TimelineItem>
                ...
                <p class="content">
                  <Icon type="ios-bookmark-outline"
                        size="14" /><a href="http://www.smartmapdt.com">司马图集团官网</a>
                </p>
                <p class="content">
  ...
  .ignore {
    .resume-con {
      ...
      h1 {
        ...
        text-align: center;
        color: #fff;
        text-shadow: 0px 1px 4px rgba(255, 255, 255, 255.29);
        &::after {
          content: "";
          position: absolute;
          left: 0;
      ...
      .left-nav {
        ...
        .clicked .ufo {
          font-weight: 700;
          animation: ufo 2s ease-in-out infinite;
        }
        .sel .sun,
        .clicked .sun {
          font-weight: 700;
        ...
        .clicked .star {
          top: -10px;
          font-weight: 700;
          animation: yunshi 2s ease-in-out infinite;
        }
        .sel .moon,
        .clicked .moon {
          font-weight: 700;
          animation: shack 4s ease-in infinite;
        }
      }
      .my-item {
        padding: 10px;
...
@keyframes effect {
  ...
  40%,
  to {
    box-shadow: 0 0 0 2px hsla(0, 0%, 100%, 0.1), 0 0 10px 10px #302f2f,
      0 0 0 10px hsla(0, 0%, 100%, 0.5);
  }
  to {
    opacity: 0;
